...
INSERT INTO subscription_plan (label, price) VALUES ('Basic', 03.99);
INSERT INTO subscription_plan (label, price) VALUES ('Standard', 10.99);
INSERT INTO subscription_plan (label, price) VALUES ('Premium', 15.99);
...
VALUES ('john.doe@gmail.com', 'John', 'Doe', 'toto', '080-1111-2222', 'Accountant', 'Basic', 'http://localhost:8080/profile_picture.png');
INSERT INTO juser (email, first_name, last_name, password, phone, profession_label, membership_label, profile_picture)
VALUES ('jane.doe@gmail.com', 'Jane', 'Doe', 'tototo', '091-3333-4444', 'Clerk Accountant', 'Premium', 'http://localhost:8080/profile_picture.png');
...
INSERT INTO plan_order (id, delivery_estimate, transactor_email, plan_label) VALUES ('RF120941', '2018-12-05', 'john.doe@gmail.com', 'Basic');
INSERT INTO plan_order (id, delivery_estimate, transactor_email, plan_label) VALUES ('RF151093', '2018-12-15', 'jane.doe@gmail.com', 'Standard');
